 ...
 *
 * Be sure to replace all instances of 's67_' with your project's prefix.
 ...
 */
function s67_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function s67_hide_if_no_cats( $field ) {
 ...
 */
function s67_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function s67_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object.
 */
function s67_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 's67_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function s67_register_demo_metabox() {
	$prefix = 's67_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'object_types'  => array( 's67_batch_sheet' ), // Post type
		// 'show_on_cb' => 's67_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 's67_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 's67_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 's67_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 's67_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 's67_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 's67_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function s67_register_about_page_metabox() {
	$prefix = 's67_about_';
...
add_action( 'cmb2_admin_init', 's67_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function s67_register_repeatable_group_field_metabox() {
	$prefix = 's67_group_';
	...
	$cmb_group = new_cmb2_box( array(
		...
		'object_types' => array( 's67_batch_sheet' ),
	) );
...
add_action( 'cmb2_admin_init', 's67_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function s67_register_user_profile_metabox() {
	$prefix = 's67_user_';
...
add_action( 'cmb2_admin_init', 's67_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function s67_register_taxonomy_metabox() {
	$prefix = 's67_term_';
...
add_action( 'cmb2_admin_init', 's67_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function s67_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 's67_theme_options_page',
		...
		'option_key'      => 's67_theme_options', // The option key and admin menu page slug.
 ...
 */
function s67_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 's67_register_rest_api_box' );
/**
 ...
 */
function s67_register_rest_api_box() {
	$prefix = 's67_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 's67_limit_rest_view_to_logged_in_users',
	) );
